...
/*	날짜: 2025/07/14
	...
	- Method Area 영역에 따로 관리 된다
	- new 객체 생성자 사용 없이 바로 클래스 타입으로 참조한다
...
class Increment {
	private int num1 = 0;
	public static int num2 = 0; //클래스 변수(정적 변수)
...
public class StaticTest {
	public static void main(String[] args) {
		...
		Increment ic2 = new Increment();
		Increment ic3 = new Increment();
		 ...
		 *  - 외부 생성을 막기 위해 private선언
		*/
		
		
		//여러개 생성할 필요가 없는 객체		
		//Calc cal = new Calc();
		//int result = cal.plse(1, 2);
		...
		System.out.println("1 + 2 : " + c1.plse(1, 2));
